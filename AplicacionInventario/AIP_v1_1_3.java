...
public class AIP_v1_1_3 
{
    public static void main(String[] args) 
    {
        ...
        if (respuesta.equalsIgnoreCase("si"))  //añadir la opción para que acepte simbolos de más, como por ejemplo las tildes ;(
        {
            ...
            for (Producto producto : productos) 
            {
                if (producto.nombre.equalsIgnoreCase(nombreActualizar)) 
                {
                    ...
                    System.out.printf("Nombre: %s, Cantidad: %d, Precio: %.2f\n",
